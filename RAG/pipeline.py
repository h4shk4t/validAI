...
def get_markdown_github(link: str) -> str:
    """
    ...
    # Create distribution directory
    dist_directory = f"{repo_name}_dist"
    os.makedirs(dist_directory, exist_ok=True)
    ...
    print(f"Number of files copied: {i}")
...
def pipeline(link: str, dimensions: int = 3072) -> None:
    """
...
def main():
    ...
    pipeline(args.repo_link, dimensions=3072)
