...
const Marketplace: React.FC = () => {
  ...
  const models: Model[] = useMemo(() => [
    ...
    },
    {
      ...
      reviews: [],
      description:
        "Gemma 9B is a medium-sized AI model optimized for performance and efficiency.",
    ...
    },
    {
      ...
      reviews: [],
      description:
        "A smaller variant of Llama Guard designed for lightweight applications.",
    ...
    },
    {
      ...
      reviews: [],
      description:
        "Gemma 7B is a compact model ideal for specific applications requiring lower latency.",
    ...
    () =>
      models.filter(
        (model) =>
          ...
          (activeItem === "" ||
            activeItem.includes("All") ||
            model.subtype === activeItem)
      ),
